export const lighten = {
    ...
    colors10: ['#5B8FF9', '#61DDAA', '#65789B', '#F6BD16', '#7262fd', '#78D3F8', '#9661BC', '#F6903D', '#008685', '#F08BB4'],
    colors20: [
        '#5B8FF9',
        '#CDDDFD',
        '#61DDAA',
    ...
    sequenceColors: ['#e1ebff', '#c2d8ff', '#a0c5ff', '#8ab5fe', '#7aa7fc', '#6898fa', '#558af4', '#427de4', '#2b6fd5', '#0362c5'],
    shapes: {
        point: [
            'hollow-circle',
            'hollow-square',
    ...
    geometries: {
        interval: {
            ...
            'hollow-rect': {
                default: { style: { fill: '#FFFFFF', stroke: '#5B8FF9', lineWidth: 2, strokeOpacity: 1 } },
                active: { style: { stroke: '#000', lineWidth: 2 } },
                inactive: { style: { strokeOpacity: 0.3 } },
                selected: { style: { stroke: '#000', lineWidth: 3, strokeOpacity: 1 } },
            },
            line: {
                default: { style: { fill: '#FFFFFF', stroke: '#5B8FF9', lineWidth: 2, strokeOpacity: 1 } },
                active: { style: { stroke: '#000', lineWidth: 2 } },
        ...
        point: {
            circle: {
                default: { style: { fill: '#5B8FF9', r: 4, stroke: '#FFFFFF', lineWidth: 1, fillOpacity: 0.95 } },
            ...
            'hollow-circle': {
                default: { style: { fill: '#FFFFFF', lineWidth: 1, stroke: '#5B8FF9', strokeOpacity: 0.95, r: 4 } },
                active: { style: { stroke: '#000', strokeOpacity: 1 } },
                inactive: { style: { strokeOpacity: 0.3 } },
                selected: { style: { lineWidth: 2, stroke: '#000', strokeOpacity: 1 } },
            },
            'hollow-square': {
                default: { style: { fill: '#FFFFFF', lineWidth: 1, stroke: '#5B8FF9', strokeOpacity: 0.95, r: 4 } },
                active: { style: { stroke: '#000', strokeOpacity: 1 } },
    ...
    components: {
        axis: {
            common: {
                ...
                tickLine: { style: { lineWidth: 1, stroke: '#BFBFBF' }, alignTick: true, length: 4 },
                subTickLine: null,
                animate: true,
            },
        ...
        legend: {
            common: {
                ...
                flipPage: true,
                pageNavigator: {
                    marker: { style: { size: 12, inactiveFill: '#000', inactiveOpacity: 0.45, fill: '#000', opacity: 1 } },
        ...
        slider: {
            common: {
                ...
                textStyle: { fill: '#000', opacity: 0.45, fontSize: 12, lineHeight: 12, fontWeight: 'normal', stroke: null, lineWidth: 0 },
            },
        },
        scrollbar: {
